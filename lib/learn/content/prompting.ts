      ...
      blocks: [
        ...
        },
        {
          ...
          figure: {
            ...
            nodes: [
              { id: "prompt", label: "\"Return JSON\"", note: "prompt only", column: 0, accent: "upland" },
              { id: "jsonmode", label: "JSON mode", note: "provider flag", column: 0, accent: "shelf" },
              { id: "schema", label: "Schema-constrained", note: "response_format", column: 0, accent: "ridge" },
              { id: "g1", label: "Usually parses", column: 1, accent: "upland" },
              { id: "g2", label: "Always valid JSON", column: 1, accent: "shelf" },
              { id: "g3", label: "Always matches schema", column: 1, accent: "ridge" },
              { id: "h1", label: "Fences, prose, repair", column: 2, accent: "upland" },
              { id: "h2", label: "Wrong keys, wrong types", column: 2, accent: "shelf" },
              { id: "h3", label: "Refusals, truncation, wrong values", column: 2, accent: "ridge" },
            ],
            edges: [
              { from: "prompt", to: "g1" },
              { from: "jsonmode", to: "g2" },
        ...
        },
        {
          ...
          figure: {
            ...
            points: [
              ...
              { label: "summarise a paragraph", x: 0.25, y: 0.3, accent: "ridge" },
              { label: "constraint scheduling", x: 0.88, y: 0.9, accent: "shelf" },
              { label: "cost arithmetic", x: 0.7, y: 0.85, accent: "shelf" },
              { label: "code with edge cases", x: 0.82, y: 0.68, accent: "shelf" },
