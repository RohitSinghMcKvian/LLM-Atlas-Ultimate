      ...
      blocks: [
        ...
        },
        {
          ...
          figure: {
            ...
            nodes: [
              { id: "text", label: "\"tokenization\"", column: 0, accent: "cyan" },
              { id: "p1", label: "token", column: 1 },
              { id: "p2", label: "ization", column: 1 },
              { id: "v1", label: "19158", note: "vocab index", column: 2, accent: "violet" },
              { id: "v2", label: "1634", note: "vocab index", column: 2, accent: "violet" },
              { id: "emb", label: "2 vectors", note: "into the network", column: 3, accent: "amber" },
            ],
            edges: [
              { from: "text", to: "p1" },
              { from: "text", to: "p2" },
...
cosine(v1, v3)   # 0.22  — same document, different topic`,
        ...
        },
        {
          ...
          figure: {
            ...
            points: [
              { label: "paraphrase", x: 0.15, y: 0.9, accent: "cyan" },
              { label: "exact quote", x: 0.92, y: 0.94, accent: "cyan" },
              { label: "same words, opposite claim", x: 0.88, y: 0.12, accent: "amber" },
      ...
      blocks: [
        ...
        },
        {
          ...
          figure: {
            ...
            items: [
              { label: "500 tokens", value: 0.25, accent: "cyan" },
              { label: "1,000 tokens", value: 1, accent: "cyan" },
              { label: "4,000 tokens", value: 16, accent: "amber" },
              { label: "16,000 tokens", value: 256, accent: "amber" },
      ...
      blocks: [
        ...
        },
        {
          ...
          figure: {
            ...
            unit: "tokens",
            items: [
              { label: "System prompt", value: 420, accent: "violet" },
              { label: "Tool definitions", value: 1150, accent: "violet", note: "Easy to forget — grows every time someone adds a tool" },
              { label: "Conversation history", value: 8400, accent: "cyan", note: "Grows every single turn" },
              { label: "Retrieved documents", value: 6200, accent: "amber" },
      ...
      blocks: [
        ...
        },
        {
          ...
          figure: {
            ...
            nodes: [
              { id: "wrong", label: "Confident wrong answer", column: 0, accent: "amber" },
              ...
              { id: "retrieve", label: "Add retrieval", note: "knowledge gap", column: 2, accent: "cyan" },
              { id: "ground", label: "Require citations", note: "context failure", column: 2, accent: "cyan" },
              { id: "reason", label: "Give it room to reason", note: "reasoning failure", column: 2, accent: "violet" },
            ],
            edges: [
