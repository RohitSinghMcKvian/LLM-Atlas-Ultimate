      ...
      blocks: [
        ...
        },
        {
          ...
          figure: {
            ...
            unit: "ms",
            items: [
              { label: "Overhead", value: 240, accent: "shelf", note: "Fixed, mostly not yours to fix" },
              { label: "Prefill 4K tokens", value: 660, accent: "shelf", note: "Cacheable if the prefix is stable" },
              { label: "Decode 200 tokens", value: 2200, accent: "ridge", note: "Streamable" },
              { label: "Decode 800 tokens", value: 8900, accent: "upland", note: "The number that actually hurts" },
            ],
          },
          caption:
      ...
      blocks: [
        ...
        },
        {
          ...
          figure: {
            ...
            items: [
              { label: "r = 5%", value: 15, accent: "ridge", note: "Excellent" },
              { label: "r = 20%", value: 30, accent: "ridge" },
              { label: "r = 50%", value: 60, accent: "upland" },
              { label: "r = 80%", value: 90, accent: "upland", note: "Barely worth the complexity" },
      ...
      blocks: [
        ...
        },
        {
          ...
          figure: {
            ...
            points: [
              { label: "house style", x: 0.12, y: 0.9, accent: "shelf" },
              { label: "unusual output format", x: 0.2, y: 0.82, accent: "shelf" },
              { label: "distil a big model", x: 0.15, y: 0.7, accent: "shelf" },
              { label: "product docs", x: 0.85, y: 0.15, accent: "ridge" },
              { label: "pricing and policy", x: 0.9, y: 0.1, accent: "ridge" },
              { label: "domain vocabulary", x: 0.3, y: 0.45, accent: "upland" },
            ],
          },
          caption:
  ...
  totalMs: number;
        ...
        { type: "h", text: "Dashboard, or page someone?" },
        {
          ...
          figure: {
            ...
            nodes: [
              { id: "wrong", label: "Wrong answer reported", column: 0, accent: "upland" },
              ...
              { id: "retr", label: "Retrieval regression", note: "check the index", column: 2, accent: "ridge" },
              { id: "trunc", label: "Truncation", note: "raise the output cap", column: 2, accent: "shelf" },
              { id: "gen", label: "Generation failure", note: "check the prompt version", column: 2, accent: "shelf" },
            ],
            edges: [
              { from: "wrong", to: "ids" },
