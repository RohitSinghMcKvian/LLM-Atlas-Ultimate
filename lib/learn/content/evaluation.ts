    ...
    return overall`,
        ...
        },
        {
          ...
          figure: {
            ...
            unit: "% pass",
            items: [
              { label: "Overall (before)", value: 92, accent: "cyan" },
              { label: "Overall (after)", value: 94, accent: "cyan", note: "Looks like a win" },
              { label: "English (after)", value: 96, accent: "cyan" },
              { label: "German (after)", value: 71, accent: "amber", note: "Was 91. This is the actual news" },
...
"completeness": n, "evidence": "quote"}`,
        ...
        { type: "h", text: "Pointwise or pairwise?" },
        {
          ...
          figure: {
            ...
            points: [
              { label: "pairwise + swap", x: 0.15, y: 0.9, accent: "cyan" },
              { label: "pointwise rubric", x: 0.85, y: 0.15, accent: "violet" },
              { label: "tournament", x: 0.8, y: 0.85, accent: "amber" },
