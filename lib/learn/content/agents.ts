...
return partial(messages, "max_steps");`,
        ...
        },
        {
          ...
          figure: {
            ...
            unit: "K input tokens",
            items: [
              { label: "5 steps", value: 30, accent: "ridge" },
              { label: "10 steps", value: 110, accent: "ridge" },
              { label: "20 steps", value: 420, accent: "upland" },
              { label: "30 steps", value: 930, accent: "upland" },
      ...
      blocks: [
        ...
        },
        {
          ...
          figure: {
            ...
            nodes: [
              { id: "goal", label: "Goal + plan", column: 0, accent: "shelf" },
              { id: "a", label: "Search the codebase", note: "own context", column: 1, accent: "ridge" },
              { id: "b", label: "Read the API docs", note: "own context", column: 1, accent: "ridge" },
              { id: "c", label: "Check the schema", note: "own context", column: 1, accent: "ridge" },
              { id: "compose", label: "3 short findings", note: "not 3 transcripts", column: 2, accent: "upland" },
            ],
            edges: [
              { from: "goal", to: "a" },
              { from: "goal", to: "b" },
