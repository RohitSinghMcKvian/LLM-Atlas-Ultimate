  ...
  return (
    <section className="relative mx-auto max-w-7xl px-4 py-20 sm:px-6 sm:py-28">
      ...
      <div className="relative mx-auto hidden aspect-[1000/600] w-full max-w-5xl lg:block">
        ...
        >
          <div className="relative grid size-24 place-items-center rounded-3xl border border-cyan/30 bg-surface shadow-glow-primary">
            <div className="absolute -inset-3 rounded-full bg-gradient-primary opacity-20 blur-2xl" />
              ...
              <Tooltip>
                <TooltipTrigger asChild>
                  <Link href={m.href}>
                    ...
                    >
                      <div className="grid size-14 place-items-center rounded-2xl border border-border bg-surface/80 backdrop-blur transition-all group-hover:border-cyan/50 group-hover:shadow-glow-primary">
      ...
      <div className="grid grid-cols-2 gap-3 sm:grid-cols-3 lg:hidden">
        {MODULES.map((m) => (
          <Link
            key={m.id}
            href={m.href}
            className="flex flex-col items-center gap-2 rounded-2xl border border-border bg-surface/50 p-4 text-center transition-colors hover:border-cyan/40"
          >
