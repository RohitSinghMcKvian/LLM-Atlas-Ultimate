  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed bottom-20 right-4 z-40 grid size-12 place-items-center rounded-2xl bg-gradient-primary text-primary-foreground shadow-glow-primary lg:hidden"
      >
                ...
                {modulesByGroup(group).map((m) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      {m.label}
                      {m.status === "soon" && (
                        <span className="ml-auto rounded-md border border-border px-1.5 py-0.5 text-[10px] uppercase text-muted-foreground">
                          Soon
                        </span>
                      )}
                    </Link>
